...
public class FirstFragment extends Fragment implements  View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b = (Button) v.findViewById(R.id.button_UW_PURPLE);
        //Use a method reference to add the OnClickListener
        b.setOnClickListener(this::setPurple);

        b = (Button) v.findViewById(R.id.button_UW_GOLD);
        //Use a method reference to add the OnClickListener
        b.setOnClickListener(this::setGold);
    ...
    public void onClick(View view){
        if (mListener != null) {
            switch (view.getId()) {
                case R.id.button_first_red: mListener.onFragmentInteraction(Color.RED);
                break;
            default:
